...
#define USER_HEAP_MAX 0xA0000000 /*0xC0000000*/
...
//2016: sharing location should be in the second 500 MB of the user 1 G.B. heap area
//		and the user heap area should shrink to only 500MB
#define USER_SHARED_MEM_START USER_HEAP_MAX
#define USER_SHARED_MEM_MAX (USER_HEAP_MAX + 500*0x100000)
